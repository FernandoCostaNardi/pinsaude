...
class RbacIntegrationTest {
    ...
    @Test
    void perfil_medico_naoPodeAcessar_gestao_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/gestao")
                .with(jwt().authorities(new SimpleGrantedAuthority("ROLE_medico"))))
                .andExpect(status().isForbidden());
    }

    @Test
    void perfil_operacao_naoPodeAcessar_gestao_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/gestao")
    ...
    @Test
    void perfil_financeiro_naoPodeAcessar_gestao_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/gestao")
    ...
    @Test
    void perfil_contabil_naoPodeAcessar_gestao_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/gestao")
    ...
    @Test
    void perfil_gestao_podeAcessar_gestao_retorna200() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/gestao")
