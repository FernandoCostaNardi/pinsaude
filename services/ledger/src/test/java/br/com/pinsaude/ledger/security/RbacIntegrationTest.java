...
class RbacIntegrationTest {
    ...
    @Test
    void perfil_medico_naoPodeAcessar_ledger_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/ledger")
                .with(jwt().authorities(new SimpleGrantedAuthority("ROLE_medico"))))
                .andExpect(status().isForbidden());
    }

    @Test
    void perfil_operacao_naoPodeAcessar_ledger_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/ledger")
    ...
    @Test
    void perfil_contabil_naoPodeAcessar_ledger_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/ledger")
    ...
    @Test
    void perfil_financeiro_podeAcessar_ledger_retorna200() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/ledger")
    ...
    @Test
    void perfil_gestao_podeAcessar_ledger_retorna200() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/ledger")
