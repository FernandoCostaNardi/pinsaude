package br.com.pinsaude.onboarding.security;
...
class RbacIntegrationTest {
    ...
    @Test
    void perfil_medico_naoPodeAcessar_onboarding_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/onboarding")
                .with(jwt().authorities(new SimpleGrantedAuthority("ROLE_medico"))))
                .andExpect(status().isForbidden());
    }

    @Test
    void perfil_financeiro_naoPodeAcessar_onboarding_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/onboarding")
    ...
    @Test
    void perfil_contabil_naoPodeAcessar_onboarding_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/onboarding")
    ...
    @Test
    void perfil_operacao_podeAcessar_onboarding_retorna200() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/onboarding")
    ...
    @Test
    void perfil_gestao_podeAcessar_onboarding_retorna200() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/onboarding")
