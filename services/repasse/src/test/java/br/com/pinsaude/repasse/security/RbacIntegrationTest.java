...
class RbacIntegrationTest {
    ...
    @Test
    void perfil_medico_naoPodeAcessar_repasse_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/repasse")
                .with(jwt().authorities(new SimpleGrantedAuthority("ROLE_medico"))))
                .andExpect(status().isForbidden());
    }

    @Test
    void perfil_operacao_naoPodeAcessar_repasse_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/repasse")
    ...
    @Test
    void perfil_contabil_naoPodeAcessar_repasse_retorna403() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/repasse")
    ...
    @Test
    void perfil_financeiro_podeAcessar_repasse_retorna200() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/repasse")
    ...
    @Test
    void perfil_gestao_podeAcessar_repasse_retorna200() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/repasse")
