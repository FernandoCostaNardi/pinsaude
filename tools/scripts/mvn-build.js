...
if (!module_) { console.error('Usage: node mvn-build.js <module>'); process.exit(1); }
...
console.log(`> mvn clean package -pl ${module_} -am -DskipTests`);
const result = spawnSync(mvnPath, ['clean', 'package', '-pl', module_, '-am', '-DskipTests'], {
  cwd: workspaceRoot,
  stdio: 'inherit',
  shell: true,
